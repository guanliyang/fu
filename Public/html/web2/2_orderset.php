		...
		<div class="list">
			...
			<table>
				...
				<tr id="trRcon">
					<td width="60"></td>
					<td width="90">　联系人：</td>
					<td colspan="2"><input name="cpaddress" value="赵钱孙" type="text"/></td>
					<td width="90">　手机号：</td>
					<td colspan="2"><input name="cpaddress" value="13910533527" type="text"/></td>
				</tr>
			</table>
			<table>
				<tr>
			...
			<<a href="">预览购买合同</a>>　　　　<input type="checkbox" class="bt_s"/> 我已阅读并了解合同详细内容，同意签属并确认其法律效力。
			<div class="list_page">
