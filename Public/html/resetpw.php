...
<div class="bdiv cont">
	<div class="inp">
		<div class="tit"><a href="#" onclick="window.history.go(-1);"><返回</a><h2>重置密码</h2></div>
		<div class="reg">
			手机号：<input name="mobile" value="" type="text"/><br/>
			...
			新密码：<input name="password" value="" type="text"/><br/><br/>
